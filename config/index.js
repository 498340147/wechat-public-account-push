export const USER_CONFIG = {
  ...
  USERS: [
    {
      ...
      festivals: [
        ...
        {"type": "*生日", "name": "汤汤", "year": "2004", "date": "12-04"},
        // 注意：此条配置日期为阳历日期，因为`type`中 “生日” 之前没有 * 符号
        {"type": "生日", "name": "小欧", "year": "2001", "date": "11-19"},
      ],
  ...
  CALLBACK_TEMPLATE_ID: "rZYoqzwkbhGZYW7hmcUCGn9nPEpMUrEPrDkwls6znDE",
  ...
  SLOT_LIST: [
    ...
    {"keyword": "lover_prattle", contents: [
        "乖乖有你陪着真的很好很好。",
        "做不了你的王子，至少让我成为守护你的骑士。",
        "如果还有机会我还是想大声告诉你：我中意你",
        "遇见你，生活便有了色彩",
      ]},
    // 你可以不断按格式往下增加
    // ...
